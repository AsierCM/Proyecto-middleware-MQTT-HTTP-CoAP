...
public  class CoapResource implements Resource {
	...
	public void removeObserveRelation(ObserveRelation relation) {
		...
		for (ResourceObserver obs:observers)
			...
			protocoloInteraccionCoap.cancelarComunicacion(relation.getSource().toString());
			
			System.out.println("Relacion eliminada de: " +relation.getSource().toString());
	}
	...
	public void setProtocoloInteraccionSuper(ProtocoloInteraccionCoap _protocoloInteraccionCoap){
		System.out.println("Soy el COAPRESOURCE y establezo protocoloInteraccionCoap");
