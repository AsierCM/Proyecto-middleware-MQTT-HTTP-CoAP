...
public class SSLUtilHTTP {
    ...
    public SSLUtilHTTP(String keyStorePassword, String keyStoreLocation) {
        this(keyStorePassword, keyStoreLocation, "", "");
    }

    public SSLUtilHTTP(String keyStorePassword, String keyStoreLocation, String tlsVersion, String keyManagerInstance) {
